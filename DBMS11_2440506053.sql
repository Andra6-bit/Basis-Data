...
--
-- Host: localhost    Database: DBMS11_2440506053
-- ------------------------------------------------------
...
CREATE TABLE `tbpegawai` (
  ...
  PRIMARY KEY (`nip`),
  KEY `fk_gol` (`gol`),
  CONSTRAINT `fk_gol` FOREIGN KEY (`gol`) REFERENCES `tbgaji` (`gol`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-03-19  8:51:43
